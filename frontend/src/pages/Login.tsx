  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-sm flex flex-col items-center gap-6">
        ...
        <div className="w-full flex flex-col gap-2">
          ...
          <p className="text-center text-sm text-white/40">
            {mode === 'signin'
              ...
              : 'Unify all your cloud drives in one place'}
          </p>
        </div>

        {/* Tab switch */}
        <div className="grid w-full grid-cols-2 rounded-xl bg-white/5 p-1 border border-white/10">
          <button
            type="button"
            onClick={() => {
              setMode('signin')
        ...
        {error && (
          <div className="w-full rounded-xl border border-red-500/20 bg-red-500/10 px-4 py-3 text-xs text-red-400 text-center animate-fadeIn">
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="w-full flex flex-col gap-3.5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-2 w-full rounded-xl bg-[#2AABEE] px-4 py-3 text-sm font-bold uppercase tracking-wider text-white transition-colors hover:bg-[#1a90cc] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
        ...
        <p className="text-xs text-white/30">
          ...
          <button
            ...
            className="text-[#2AABEE] hover:underline ml-1"
          >
